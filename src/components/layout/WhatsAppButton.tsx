...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      // Counted by AnalyticsEvents under this label. The only always-visible control on a
      // long article, so this is the tap most likely to be a real enquiry — and the one
      // that never reaches the inbox.
      data-cta="float"

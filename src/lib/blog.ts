...
export type BlogPost = {
  ...
  featured?: boolean;
  /**
   * Set while an article is live but its named reviewer has not yet read it. Nothing carries
   * it at the moment; it stays because the next article published ahead of its review will.
   *

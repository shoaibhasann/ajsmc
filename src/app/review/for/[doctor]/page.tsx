  ...
  return (
    <div className="bg-bg pb-24 pt-[88px] lg:pt-[96px]">
      ...
      <Container className="max-w-[760px] pt-9">
        ...
        <div className="mt-8 flex flex-col gap-3.5">
          {items.map((item, i) => (
            <Link
              ...
              className="group flex items-start gap-4 rounded-[18px] border aj-card p-5 transition-shadow hover:shadow-[0_20px_40px_-28px_rgba(12,46,110,0.55)]"
            >
        ...
        <div className="mt-8 rounded-[18px] border aj-card p-5">

  ...
  return (
    ...
    <div className="bg-bg pb-24 pt-[88px] lg:pt-[96px]">
      ...
      <Container className="max-w-[820px] pt-9">
        ...
        {reviewer && (
          <div className="mt-6 rounded-[18px] border border-navy/[0.1] bg-white p-5">
        ...
        <div className="mt-5 rounded-[18px] border border-navy/[0.1] bg-white p-5">
          <p className="font-body text-[11.5px] font-bold uppercase tracking-[0.12em] text-green-deep">
        ...
        <section className="mt-8">
          ...
          <ol className="mt-5 flex list-none flex-col gap-4 p-0">
            {item.questions.map((q, i) => (
              <li key={q.q} className="rounded-[16px] border border-navy/[0.1] bg-white p-5">
        ...
        <section className="mt-8 rounded-[18px] border border-navy/[0.1] bg-white p-5">
